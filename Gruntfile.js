...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Poly.st', // list all sources in dependency order
                    'src/Poly-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-poly',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Poly', /* add other code-to-test packages here */
                    'SUnit',
                    'Poly-Tests' /* add other test packages here */
                ],
